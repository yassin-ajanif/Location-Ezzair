...
namespace GestionCommerciale.Shared.Database.Migrations
{
    ...
    [Migration("20260908103453_AddSoftReservationsAndRenameBonSortieTables")]
    partial class AddSoftReservationsAndRenameBonSortieTables
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Reservation.Models.BonSortie", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("BonsSortie", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Reservation.Models.BonSortieProduitLigne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("BonSortieProduitLignes", (string)null);
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Reservation.Models.BonSortieProduitRetour", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<int>("BonSortieProduitLigneId")
                        .HasColumnType("INTEGER");
                    ...
                    b.HasIndex("BonSortieProduitLigneId");

                    b.HasIndex("DateRetour");

                    b.ToTable("BonSortieProduitRetours", null, t =>
                        {
                            t.HasCheckConstraint("CK_BonSortieProduitRetours_Etat", "\"Etat\" IN ('good', 'damaged', 'lost', 'to clean')");
                        });
                });

            modelBuilder.Entity("GestionCommerciale.Modules.Reservation.Models.BonSortieServiceLigne", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
                    ...
                    b.ToTable("BonSortieServiceLignes", (string)null);
                });
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Livraison.Models.BonLivraison", b =>
                {
                    ...
                    b.HasOne("GestionCommerciale.Modules.Reservation.Models.BonSortie", "BonSortie")
                        .WithMany()
            ...
            modelBuilder.Entity("GestionCommerciale.Modules.Reservation.Models.BonSortieProduitRetour", b =>
                {
                    b.HasOne("GestionCommerciale.Modules.Reservation.Models.BonSortieProduitLigne", "BonSortieProduitLigne")
                        .WithMany("Retours")
                        .HasForeignKey("BonSortieProduitLigneId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("BonSortieProduitLigne");
                });
